...
import { Spinner, Button, Container } from "./UI.jsx";
  ...
  return (
    <>
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <Container className="relative mx-auto flex flex-col justify-center items-center h-full text-center px-6">
          <h2 className="text-5xl md:text-7xl lg:text-9xl font-bold text-yellow-400">
            GOFLEX
          </h2>
          <p className="text-xl md:text-2xl text-white mt-4 mb-8">
            최신 영화와 인기 작품을 만나보세요.
          </p>
          {hero && (
